  ...
  <div class="w-full h-full flex pt-20 justify-center items-center">
    <div class="relative md:w-[500px] md:h-fit pb-10">
      ...
      <div class="w-full rounded-md overflow-hidden mt-5 border-[1px]">
        ...
        <div
          class="w-full flex justify-between border-t-[1px] bg-primary-300 p-5"
        >
          <div>
      ...
      <div
        v-if="tracking"
        class="w-full rounded-md overflow-hidden flex flex-col gap-2 mt-5 border-[1px] p-5"
      >
        <div
          v-for="(item, index) in tracking"
          :key="item.id"
          class="flex min-h-[80px]"
        >
