<template>
  <div class="py-6 w-full mt-5 mx-auto">
    <div class="text-2xl font-bold text-[#34547F] flex justify-center">
      Özüňi gowy duýmagyň üçin biz şu ýerde.
    </div>
    <div
      class="flex items-start lg:items-center justify-center flex-col lg:flex-row gap-10 mt-8"
    >
      <div
        class="w-80 cursor-pointer h-50 flex flex-col gap-2 hover:text-[#1B6494]"
      >
        <svg
          width="5em"
          height="44px"
        ...
        <span class="text-3xl">Dartgynlylygyňy azalt. </span>
        <span style="color: #000000 !important">
          Dartgynlyk we howsalanyň arasynda rahatlanmaga kömek edýäris –
          ýaşaýşyňdan lezzet almagy dowam et!
        </span>
        <span class="underline font-bold"> Giňişleýin öwren</span>
      </div>
      ...
      >
        ...
        <spam class="text-3xl">Ukyňy artdyr.</spam>
        <spam style="color: #000000 !important"
          >Tebigy we rahat ýagdaýda uklap, dynç al.
        </spam>
        <spam class="underline font-bold">Giňişleýin öwren</spam>
      </div>
      <div
        class="w-80 cursor-pointer h-50 flex flex-col gap-2 hover:text-[#1B6494]"
      >
        ...
        <span class="text-3xl">Manyly ýaşa.</span>
        <span style="color: #000000 !important">
          Durmuşyň belentliklerini we pesliklerini durnuklylyk, ynam we
          ugrukdyryjy goldaw bilen aş.</span
        >
        <span class="underline font-bold"> Giňişleýin öwren</span>
      </div>
    </div>
