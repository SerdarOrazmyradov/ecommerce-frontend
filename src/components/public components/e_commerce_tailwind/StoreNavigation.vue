      ...
      <div class="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
        ...
        <div class="border-t border-gray-200 px-4 py-6">
          <a href="#" class="-m-2 flex items-center p-2">
            <img src="https://tailwindcss.com/plus-assets/img/flags/flag-canada.svg" alt="practising" class="block h-auto w-5 shrink-0" />
        ...
        <div class="flex h-16 items-center">
          ...
          <div class="ml-4 flex lg:ml-0">
            <a href="#">
              ...
              <img class="h-8 w-auto" src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=600" alt="practising" />
            </a>
          </div>
              ...
              <div class="flex">
                ...
                <!--
                  ...
                  Leaving: "transition ease-in duration-150"
                    ...
                    To: "opacity-0"
                -->
                <div class="absolute inset-x-0 top-full z-20 w-full bg-white text-sm text-gray-500">
